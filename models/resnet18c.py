...
def ResNet18C(input_shape, num_classes, dense_classifier=False, pretrained=True):
    return ResNet(get_builder(), BasicBlock, [2, 2, 2, 2], num_classes)


def ResNet34C(input_shape, num_classes, dense_classifier=False, pretrained=True):
    return ResNet(get_builder(), BasicBlock, [3, 4, 6, 3], num_classes)


def ResNet50C(input_shape, num_classes, dense_classifier=False, pretrained=True):
    return ResNet(get_builder(), Bottleneck, [3, 4, 6, 3], num_classes)


def ResNet101C(input_shape, num_classes, dense_classifier=False, pretrained=True):
    return ResNet(get_builder(), Bottleneck, [3, 4, 23, 3], num_classes)


def ResNet152C(input_shape, num_classes, dense_classifier=False, pretrained=True):
